package com.passowrd.key.wifishare.adapter;
...
//# for image use "image/*"
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Download Wifi share app from playstore play.google.com/store/apps/details?id=com.passowrd.key.wifishare");
